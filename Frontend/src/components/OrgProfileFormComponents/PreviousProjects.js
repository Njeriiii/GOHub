...
return (
    <div className="flex flex-col justify-center">
        ...
        <div class="flex gap-x-6 justify-end mb-20">
            <button onClick={handleAddProject} type="submit" class="rounded-md w-1/10 bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
            + Add Project 
            </button>
        </div>
